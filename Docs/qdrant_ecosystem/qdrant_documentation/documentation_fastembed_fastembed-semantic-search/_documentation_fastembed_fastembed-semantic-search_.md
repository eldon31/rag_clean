...
- [Using FastEmbed with Qdrant for Vector Search](#using-fastembed-with-qdrant-for-vector-search.md)

  - [Install Qdrant Client and FastEmbed](#install-qdrant-client-and-fastembed.md)
  - [Initialize the client](#initialize-the-client.md)
  - [Add data](#add-data.md)
  - [Create a collection](#create-a-collection.md)
  - [Upsert documents to the collection](#upsert-documents-to-the-collection.md)

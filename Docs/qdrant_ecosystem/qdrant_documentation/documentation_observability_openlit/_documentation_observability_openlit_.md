...
We are sorry to hear that. 😔 You can [edit](https:/github.com/qdrant/landing_page/tree/master/qdrant-landing/content/documentation/observability/openlit.md) this page on GitHub, or [create](https://github.com/qdrant/landing_page/issues/new/choose) a GitHub issue.
...
- [OpenLIT](#openlit.md)
  ...
  - [Usage](#usage.md)
    ...
    - [Step 1: Install OpenLIT](#step-1-install-openlit.md)
    - [Step 2: Initialize OpenLIT in your Application](#step-2-initialize-openlit-in-your-application.md)

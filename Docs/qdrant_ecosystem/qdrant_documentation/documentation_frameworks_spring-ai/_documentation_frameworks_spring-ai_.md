...
If the collection is not [created in advance](https://qdrant.tech/documentation/concepts/collections/#create-a-collection), `QdrantVectorStore` will attempt to create one using cosine similarity and the dimension of the configured `EmbeddingClient`.

...
You can also set the variables by creating .env file, using our [template.](https://github.com/topoteretes/cognee/blob/main/.env.template) To use different LLM providers, for more info check out our [documentation](https://docs.cognee.ai)
...
We are sorry to hear that. 😔 You can [edit](https:/github.com/qdrant/landing_page/tree/master/qdrant-landing/content/documentation/data-management/cognee.md) this page on GitHub, or [create](https://github.com/qdrant/landing_page/issues/new/choose) a GitHub issue.
...
- [cognee](#cognee.md)
  ...
  - [📦 Installation](#-installation.md)
    - [With pip](#with-pip.md)

  - [Local Cognee installation](#local-cognee-installation.md)
    - [with UV with all optional dependencies](#with-uv-with-all-optional-dependencies.md)
...
* [Edit on Github](https://github.com/qdrant/landing_page/tree/master/qdrant-landing/content/documentation/data-management/cognee.md)

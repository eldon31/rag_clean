...
"""
Kaggle GPU Script: Embed docling-project_docling collection (Self-Contained)

USAGE IN KAGGLE:
    1. Upload this script to Kaggle notebook
    2. Add docling-project_docling_chunked as input dataset
    3. Set accelerator to GPU T4 x2
    4. Run: !python embed_docling_self_contained.py

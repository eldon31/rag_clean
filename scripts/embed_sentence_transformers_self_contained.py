...
"""
Kaggle GPU Script: Embed sentence_transformers_docs collection (Self-Contained)

USAGE IN KAGGLE:
    1. Upload this script to Kaggle notebook
    2. Add sentence-transformers-docs-chunked as input dataset
    3. Set accelerator to GPU T4 x2
    4. Run: !python embed_sentence_transformers_self_contained.py

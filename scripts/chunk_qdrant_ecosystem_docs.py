"""
Chunk Qdrant Ecosystem Documentation using HybridChunker
...
INPUT_DIR = Path("Docs/qdrant_ecosystem")
OUTPUT_CHUNKED_DIR = Path("output/qdrant_ecosystem/chunked")
...
def main():
    ...
    print(f"\n{'='*60}")
    print("QDRANT ECOSYSTEM DOCS CHUNKING PIPELINE")
    print(f"\n{'='*60}")

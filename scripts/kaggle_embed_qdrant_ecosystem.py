"""Kaggle-friendly embedding launcher for qdrant_ecosystem."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Embed qdrant_ecosystem collection")
    default_input = os.getenv("EMBED_INPUT", "/kaggle/input/qdrant-ecosystem-chunked")
    default_output = os.getenv(
        "EMBED_OUTPUT",
        "outputs/embed/qdrant_ecosystem_embeddings_768.jsonl",
    )

...
Generated on: 2025-10-16T19:21:32.093894
...
4. Run this script: python Qdrant_v4_upload_script.py
"""
...
def upload_to_qdrant(recreate_collection: bool = False):
    ...
    FILES = {
        "embeddings": str(script_dir / "Qdrant_v4_embeddings.npy"), 
        "metadata": str(script_dir / "Qdrant_v4_metadata.json"),
        "texts": str(script_dir / "Qdrant_v4_texts.json"),
        "stats": str(script_dir / "Qdrant_v4_stats.json")
    }
...
if __name__ == "__main__":
    logger.info("=" * 60)
    logger.info("QDRANT ECOSYSTEM COLLECTION UPLOAD")
    logger.info("=" * 60)

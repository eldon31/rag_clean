...
Generated on: 2025-10-16T19:22:56.178958
...
4. Run this script: python FAST_DOCS_v4_upload_script.py
"""
...
def upload_to_qdrant(recreate_collection: bool = False):
    ...
    FILES = {
        "embeddings": str(script_dir / "FAST_DOCS_v4_embeddings.npy"), 
        "metadata": str(script_dir / "FAST_DOCS_v4_metadata.json"),
        "texts": str(script_dir / "FAST_DOCS_v4_texts.json"),
        "stats": str(script_dir / "FAST_DOCS_v4_stats.json")
    }
            ...
            point = PointStruct(
                ...
                payload={
                    **metadata,
                    ...
                    "collection_source": "FAST_DOCS_v4",
...
if __name__ == "__main__":
    logger.info("=" * 60)
    logger.info("FAST_DOCS COLLECTION UPLOAD")
    logger.info("=" * 60)

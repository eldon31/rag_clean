#!/usr/bin/env python3
"""
Create all upload scripts with proper formatting
"""
...
4. Run this script: python {script_name}
"""
...
def upload_to_qdrant(recreate_collection: bool = False):
    ...
    FILES = {{
        "embeddings": str(script_dir / "{prefix}_embeddings.npy"), 
        "metadata": str(script_dir / "{prefix}_metadata.json"),
        "texts": str(script_dir / "{prefix}_texts.json"),
        "stats": str(script_dir / "{prefix}_stats.json")
    }}
...
if __name__ == "__main__":
    logger.info("=" * 60)
    logger.info("{title} COLLECTION UPLOAD")
    logger.info("=" * 60)
...
collections = [
    {
        ...
        "prefix": "Docling_v4",
        "script_name": "Docling_v4_upload_script.py",
        "source_name": "Docling_v4",
        "title": "DOCLING",
        "generation_date": "2025-10-16T19:03:42.363399",
        "folder": "Docling_v4_outputs"
    },
    {
        "collection_name": "fast_docs",
        "prefix": "FAST_DOCS_v4",
        "script_name": "FAST_DOCS_v4_upload_script.py",
        "source_name": "FAST_DOCS_v4",
        "title": "FAST_DOCS",
        "generation_date": "2025-10-16T19:22:56.178958",
        "folder": "FAST_DOCS_v4_outputs"
    },
    {
        "collection_name": "pydantic",
        "prefix": "pydantic_pydantic_v4",
        "script_name": "pydantic_pydantic_v4_upload_script.py",
        "source_name": "pydantic_pydantic_v4",
        "title": "PYDANTIC",
        "generation_date": "2025-10-16T19:04:07.935798",
        "folder": "pydantic_pydantic_v4_outputs"
    },
    {
        "collection_name": "qdrant_ecosystem",
        "prefix": "Qdrant_v4",
        "script_name": "Qdrant_v4_upload_script.py",
        "source_name": "Qdrant_v4",
        "title": "QDRANT ECOSYSTEM",
        "generation_date": "2025-10-16T19:21:32.093894",
        "folder": "Qdrant_v4_outputs"
    },
    {
        "collection_name": "sentence_transformers",
        "prefix": "Sentence_Transformers_v4",
        "script_name": "Sentence_Transformers_v4_upload_script.py",
        "source_name": "Sentence_Transformers_v4",
        "title": "SENTENCE TRANSFORMERS",
        "generation_date": "2025-10-16T19:22:11.007381",
        "folder": "Sentence_Transformers_v4_outputs"
    }
]
...
for config in collections:
    script_content = upload_script_template.format(**config)
    script_path = Path(config["folder"]) / config["script_name"]
...
print("\n🎉 All upload scripts created successfully!")

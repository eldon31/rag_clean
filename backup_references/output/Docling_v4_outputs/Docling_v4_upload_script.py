...
Generated on: 2025-10-16T19:03:42.363399
...
4. Run this script: python Docling_v4_upload_script.py
"""
...
def upload_to_qdrant(recreate_collection: bool = False):
    ...
    FILES = {
        "embeddings": str(script_dir / "Docling_v4_embeddings.npy"), 
        "metadata": str(script_dir / "Docling_v4_metadata.json"),
        "texts": str(script_dir / "Docling_v4_texts.json"),
        "stats": str(script_dir / "Docling_v4_stats.json")
    }
...
if __name__ == "__main__":
    logger.info("=" * 60)
    logger.info("DOCLING COLLECTION UPLOAD")
    logger.info("=" * 60)
